...
**Deprecated** Use of Argo for E2E tests is deprecated. Please look at [tekton.md](tekton.md) 
for instructions on using Tekton.

This page provides guidelines for writing Argo workflows to use as E2E tests
